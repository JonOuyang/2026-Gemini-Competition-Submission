...
try:
	...
	class CloudAuthConfig:
		"""Compatibility fallback when browser_use.sync is not available."""
		...
		def load_from_file(cls):
			# Keep behavior compatible with caller: raise when no persisted auth exists.
			raise FileNotFoundError('browser_use.sync.auth is unavailable')
